  ...
  return (
    ...
    >
      ...
      <nav className="sticky top-0 z-50 border-b border-white/10 bg-black/30 text-white backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-4 py-4 sm:flex-nowrap sm:px-6">
        ...
        <div className="grid gap-6 lg:grid-cols-12">
          ...
          >
            <div className="flex items-start justify-between">
              <div>
                <p className="label-metadata text-white/60">Midnight Ops</p>
              ...
              {statCards.map((card) => (
                ...
                >
                  ...
                  <div className="relative z-10 flex items-start justify-between">
                    <div>
                      <p className="text-[11px] font-medium uppercase tracking-wider text-white/60">{card.title}</p>
